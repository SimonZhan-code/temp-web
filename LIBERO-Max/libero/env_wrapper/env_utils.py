"""Environment utility functions for LIBERO wrappers."""
...
def tile_images(
    ...
    """
    Tile multiple images to a single image comprised of nrows and an appropriate
    number of columns to fit all the images.
    """
    batched = False
