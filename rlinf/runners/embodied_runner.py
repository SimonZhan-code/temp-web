...
class EmbodiedRunner:
    ...
    def run(self):
        ...
        # Optional eval BEFORE any training (epoch 0 baseline), e.g. to sanity-check the
        # eval path / LDBA subgoal extraction on the untrained policy.
        if self.cfg.runner.get("eval_at_start", False) and start_step == 0:
